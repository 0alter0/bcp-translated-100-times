(async() => {
    ...
    if (console.log("%c Get up here %c\n	DanniDan0167 / CryptoDude3 GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Open the GitHub repository%c  https://github.com/randomstuff69/blooketcheatsplus", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
            ...
            display: "block"
                ...
                style: {
                    ...
                    overflow: "hidden"
                        ...
                        innerHTML: "GitHub - You Too Powerful 69",
                        ...
                        style: {
                            ...
                            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">A genus of enfilading plants<sup>I-15,5</sup></span>'
                        }, l("a", {
                                className: "bigButton",
                                style: {
                                    cursor: "pointer",
